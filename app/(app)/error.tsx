...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 py-24 text-center">
      ...
      <h2 className="mt-4 text-lg font-semibold text-[var(--risk-red)]">Something went wrong</h2>
      <p className="mt-1 text-sm text-[var(--text-secondary)]">{error.message || "An unexpected error occurred."}</p>
      <button
        onClick={reset}
