      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="space-y-8">
          <input
            ...
            className="w-full border-0 border-b-2 border-zinc-800 bg-transparent px-2 py-4 text-center text-2xl text-zinc-100 placeholder-zinc-700 outline-none transition focus:border-purple-500 sm:text-3xl"
          />

          <div className="flex justify-center">
            <div className="flex w-full max-w-[200px] items-center gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-2.5 transition focus-within:border-purple-500">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="flex flex-1 items-center gap-2 rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-2.5 transition focus-within:border-purple-500">
          ...
          <button
            ...
            className="mt-10 flex w-full items-center justify-center gap-3 rounded-xl bg-purple-600 px-6 py-4 text-lg font-bold text-white shadow-lg shadow-purple-600/20 transition hover:bg-purple-500 hover:shadow-purple-600/30 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {loading ? (
              <>
                <svg
              ...
              {captions.map((caption, i) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    {link && (
                      <p className="truncate text-xs text-purple-400/50">
                        {link}
                      </p>
                    )}
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-zinc-800 pt-3">
                    <button
                      ...
                      className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-xs font-medium text-zinc-500 transition hover:bg-zinc-800 hover:text-purple-400"
                    >
                      {copiedIndex === i ? (
                        t("cg.copied")
                      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/70 p-4">
          <div className="w-full max-w-lg rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl sm:p-8">
            ...
            <div className="space-y-7">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-3.5 text-sm text-zinc-100 outline-none transition focus:border-purple-500"
                >
                  {NICHES.map((n) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 outline-none transition focus:border-purple-500"
                />
              </div>
                  ...
                  {BRAND_VIBES.map((bv) => (
                    <button
                      ...
                      className={`flex items-center gap-3 rounded-xl border px-4 py-3.5 text-sm font-medium transition ${
                        formBrandVibe === bv.id
                          ? "border-purple-600 bg-purple-600/10 text-purple-300 shadow-sm shadow-purple-600/20"
            ...
            <button
              type="button"
              onClick={saveProfile}
              className="mt-8 w-full rounded-xl bg-purple-600 px-6 py-4 text-base font-bold text-white shadow-lg shadow-purple-600/20 transition hover:bg-purple-500"
            >
              {t("bp.submit")}
            </button>
          </div>
