      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-5">
            ...
            <p className="mt-2 text-sm font-medium text-zinc-200">Prevent lost revenue</p>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-5">
            ...
            <p className="mt-2 text-sm font-medium text-zinc-200">Faster decisions</p>
            <p className="mt-1 text-xs text-zinc-500">Each order shows exactly one action: verify or cancel</p>
          </div>

          <div className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-5">
            <p className="text-2xl font-bold text-purple-400">1</p>
            <p className="mt-2 text-sm font-medium text-zinc-200">Daily dashboard</p>
            <p className="mt-1 text-xs text-zinc-500">One screen answers: what orders will lose me money today?</p>
          </div>
        </div>
      </div>
    </section>
