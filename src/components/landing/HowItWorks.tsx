    ...
    <section id="how-it-works" className="border-t border-zinc-800/50 py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-sm text-zinc-500">Three steps to stop losing money on deliveries</p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="mt-4 text-base font-semibold text-zinc-200">Add your store (or use demo)</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mt-4 text-base font-semibold text-zinc-200">UGZIO simulates your real orders</h3>
            <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h3 className="mt-4 text-base font-semibold text-zinc-200">You see risky deliveries before they fail</h3>
            <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
