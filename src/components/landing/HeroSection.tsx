          ...
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl px-7 py-3.5 text-sm font-semibold text-white transition-all hover:scale-[1.02] active:scale-[0.97] touch-manipulation landing-glow-purple"
          ...
          <div className="relative lg:mt-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="landing-glass rounded-xl p-3 text-center animate-hero-float-1">
                ...
                <div className="landing-glass rounded-xl p-3 text-center animate-hero-float-2" style={{ animationDelay: "1s" }}>
                ...
                <div className="landing-glass rounded-xl p-3 text-center animate-hero-float-3" style={{ animationDelay: "2s" }}>
